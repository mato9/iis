...
function _MakePWDWidget()
{
    ...
    var conpwd = this.pwdconfirm;

	this.pwdfieldid = pwdname+"_id";

	code += "<input type='password' class='pwdfield' name='"+pwdname+"' id='"+this.pwdfieldid+"'><span id='passw_or'>*</span>";

	this.pwdtxtfield=pwdname+"_text";

	this.pwdtxtfieldid = this.pwdtxtfield+"_id";

	code += "<input type='text' class='pwdfield' name='"+this.pwdtxtfield+"' id='"+this.pwdtxtfieldid+"' style='display: none;'><span id='passw_or' style='display: none;'>*</span>";
	...
	//console.log(this.pwdfieldid);
	return this.pwdfieldid;
}
